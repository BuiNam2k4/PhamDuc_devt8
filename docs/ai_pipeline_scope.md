...
| **10** | **Kết nối Thí sinh (UserPage.tsx Integration)** | `Chưa hoàn thiện` | **Kế hoạch:** Sau khi hoàn tất kiểm thử và tinh chỉnh toàn bộ các bước AI trên trang Test Sandbox, tiến hành tích hợp luồng gửi ảnh tự động từ camera của Thí sinh (`UserPage.tsx`) trong quá trình làm bài thi thực tế. |
